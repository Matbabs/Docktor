<script>
    ...
    const GIT_HUB = "https://raw.githubusercontent.com/##REPLACE##/master/README.md"
        ...
        <div class="menu-items">
            <div class="remote card light">
                ...
                <form on:submit|preventDefault={checkRepo}>
                    <input type="text" bind:value={remoteSearch} placeholder="https://your/repo/uri">
                    <button disabled={remoteSearch === ""}>Check Repo</button>
                    <button disabled={remoteSearch === ""} on:click={() => handleScan(remoteSearch)}>Scan Repo</button>
                </form>
                <div class="dark card markdown-container">
                    ...
                    {:else}
                        <div class="no-data">
                            ...
                            <p class="red">Preview feature works only for public github project</p>
                            <h4 style="font-weight: bold;" class="purple">Scan works for all accessible repo</h4>
                        </div>
                    {/if}   
                </div>
            </div>
