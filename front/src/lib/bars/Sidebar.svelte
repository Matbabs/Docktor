<script>
    ...
    onMount(() =>{
        features.set([
            ...
            { name: "Docker Images", icon: FaDocker, path: "docker-images", color: "yellow"},
            { name: "File System", icon: FaFileMedicalAlt, path: "file-system", color: "orange"},
            { name: "Config Files", icon: FaTools, path: "config-files", color: "cyan"},
